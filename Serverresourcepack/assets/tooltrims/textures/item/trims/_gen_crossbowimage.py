...
# combinations
tool = ["crossbow","crossbow_pulling_0","crossbow_pulling_1","crossbow_pulling_2","crossbow_arrow","crossbow_firework"]
...
if answer == "y":
    for fpalettes in range(len(palettes_name)):
        ...
        input_image = Image.open("_tooltrims_crossbow_key.png")
        ...
        for j in range(0, int((height)/grid_size)):
                for i in range(0, int(width/grid_size)):
                    ...
                    splited.save(f"{tool[j]}_{trims[i]}_{palettes_name[fpalettes]}.png", format="png")